...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  const queryMarketItems = useMoralisQuery("CreatedMarketItemsETH");
  ...
  async function updateSoldMarketItem() {
    ...
    const marketList = Moralis.Object.extend("CreatedMarketItemsETH");
    ...
    <>
      <div>
        ...
        <div style={styles.NFTs}>
          ...
          {inputValue !== "explore" &&
            NFTTokenIds.slice().map((nft, index) => (
              <Card
                hoverable
                actions={[
